...
const ResetPassword = () => {
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    const url = `https://sk-smoky.vercel.app/api/user/Reset/${userToken}`;
    ...
    <div className="w-full h-[100vh] bg-[#F8F9F9] flex justify-center items-center">
      <div className="w-[30%] h-[70%] bg-white rounded-md flex justify-around items-center flex-col phone:w-[90%] phone:h-[50%]">
        ...
        <div className="w-[100%] h-[50%]  flex justify-around items-center">
          <form className="w-[100%] h-[100%] gap-4  flex justify-around flex-col items-center" onSubmit={handleResetPassword}>
            <div className="w-[90%] h-[40%]   px-1 flex justify-center items-start flex-col">
              <label className="font-bold text-blue-500">New Password <span className="text-red-600">*</span></label>
              <input 
                type="password" 
            ...
            <div className="w-[90%] h-[40%]  px-1 flex justify-center items-start flex-col">
              <label className="font-bold text-blue-500">Confirm Password <span className="text-red-600">*</span></label>
              <input 
                type="password" 
            ...
            <div className="w-[90%] h-[20%]  flex justify-center items-center">
              <button type="submit" className="py-2 transition-all duration-300 hover:bg-blue-500 text-white font-semibold px-6 rounded-md bg-blue-700">
                Reset Password
              </button>
            </div>
          </form>
        ...
        <div className="w-full h-[25%] flex flex-col items-center justify-around px-6">
          <p>Remember your password? <span className="text-slate-600 font-bold cursor-pointer" onClick={() => navigate('/login')}>Login</span></p>
