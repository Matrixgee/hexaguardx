const Support = () => {
  return (
    <div className="relative w-full h-[88vh] overflow-y-auto bg-gradient-to-br from-slate-900 via-blue-900/20 to-slate-900 flex items-center justify-center px-4">
      {/* Background Visuals */}
      ...
      {/* Support Card */}
      <div className="relative z-10 w-[70%] phone:w-[90%] max-w-3xl bg-white/5 border border-white/10 backdrop-blur-md rounded-3xl shadow-lg shadow-blue-500/10 p-8 phone:p-6 text-gray-200 space-y-6">
        <div className="space-y-2 text-center">
          ...
          <p className="text-blue-400 underline underline-offset-4 cursor-pointer hover:text-blue-300 transition text-base phone:text-sm">
